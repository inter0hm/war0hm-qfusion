...
//namespace ASUI {
//typedef Rml::DataSource DataSource;
//
////============================================
///*
...
//{
//	return Rml::DataSource::GetDataSource( ASSTR( name ) );
//}
//
...
//{
//	ASBind::Class<Rml::DataSource, ASBind::class_ref>( as->getEngine() );
//}
//
...
//{
//	ASBind::GetClass<Rml::DataSource>( as->getEngine() )
//		.refs( &dummy, &dummy )
//
...
//}
//
//ASBIND_TYPE( Rml::DataSource, DataSource );
