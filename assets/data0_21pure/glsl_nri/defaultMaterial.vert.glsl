...
#define u_ConstColor constants.constColor
#define u_RGBGenFuncArgs constants.RGBGenFuncArgs
#define u_AlphaGenFuncArgs constants.AlphaGenFuncArgs
...
void main()
{
	...
	FogGenColor(Position, outColor, constants.blendMix);
#else
	...
	v_TexCoord_FogCoord.st = TextureMatrix2x3Mul(constants.texMatrix, TexCoord);
#else
	...
	gl_Position = set_object.mvp * Position;
}
